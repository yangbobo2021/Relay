...
/** Files workbench panel floor required by its persistent reader/tree split. */
...
/** Files workbench width before any user drag. */
...
export function computeColumns(
  ...
  // Files needs its reader and tree simultaneously. Preserve that workbench
