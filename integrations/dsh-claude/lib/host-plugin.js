...
//#endregion
//#region ../claude/session-runtime.mjs
...
function createDshClaudePlugin(ctx, core, config = {}) {
	return definePlugin({
		manifest: {
			id: "relay.dsh.claude",
			version: "1.0.0",
		...
		async activate({ capabilities, defer }) {
			...
			return { capabilities: { "relay.dsh.claude.v1": Object.freeze({
				provider: CLAUDE_PROVIDER,
				core
			}) } };
		}
