...
const ID = '@relay/dsh-claude'
const CSS_MODULE = '\0relay-css-module:'
const GLOBAL_CSS = '\0relay-global-css:'
const VIRTUAL_SUFFIX = '.mjs'
const CORE_CLIENT_API = fileURLToPath(import.meta.resolve('@relay/dsh-core/client-api'))
...
const clientConfig: UserConfig = {
  ...
  plugins: [{
    name: 'relay-core-client-api',
    resolveId(source: string) {
      return source === '@relay/dsh-core/client-api' ? CORE_CLIENT_API : null
    },
  }, {
