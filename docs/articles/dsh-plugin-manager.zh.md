...
[English](dsh-plugin-manager.md) | 中文
...
![Plugin Manager 在真实 DSH 中搜索、确认并安装 Codex 插件](https://github.com/yangbobo2021/Relay/blob/codex/relay-foundation/docs/media/dsh-plugin-manager-demo.gif?raw=1)
